...
<head>
    ...
    <link rel="shortcut icon" href="<?php bloginfo('template_directory'); ?>/assets/img/common/favicon.ico"
        type="image/x-icon">
            ...
            <div class="headcontainer">
                <div class="main-header">
                    ...
                    <div class="header-ttl-sp fz-10-sp sp">
                        <p>旭川の内科・消化器内科・血液内科・感染症内科なら加藤病院</p>
                    </div>
                    <div class="header-m">
                        <h1 class="header-logo">
                            <a href="<?php echo home_url(); ?>">
                                <div class="h-logo-img">
                                    <img src="<?php bloginfo('template_directory'); ?>/assets/img/common/logo.png"
                                        alt="加藤病院" />
                                </div>
                                <p>医療法人社団 心優会<span>加藤病院</span></p>
                            </a>
                        </h1>
                                    ...
                                    <div class="search-box">
                                        <form method="get" id="searchform" class="searchform"
                                            ...
                                            <input type="text" value="<?php echo get_search_query() ?>" name="s"
                                                title="Search" placeholder="サイト内検索">
                                            <button type="submit" id="searchsubmit" value="検索" class="ser-btn">
                                                <svg class="gUZ B9u U9O kVc mr13" height="18" width="18"
                                                    viewBox="0 0 24 24" aria-label="search" role="img">
                                                    <path
                        ...
                        <ul>
                            <li>
                                <a href="<?php echo home_url() . '/gairai'; ?>">
                                    <div class="nav-img1">
                                        <img src="<?php bloginfo('template_directory'); ?>/assets/img/common/nav-img1.png"
                                            alt="外来のご案内" />
                                    </div>
                            ...
                            <li>
                                <a href="<?php echo home_url() . '/nyuuin'; ?>">
                                    <div class="nav-img2">
                                        <img src="<?php bloginfo('template_directory'); ?>/assets/img/common/nav-img2.png"
                                            alt="入院のご案内" />
                                    </div>
                            ...
                            <li>
                                <a href="<?php echo home_url() . '/department'; ?>">
                                    <div class="nav-img3">
                                        <img src="<?php bloginfo('template_directory'); ?>/assets/img/common/nav-img3.png"
                                            alt="部門紹介" />
                                    </div>
                            ...
                            <li>
                                <a href="<?php echo home_url() . '/kenshin-zaitaku'; ?>">
                                    <div class="nav-img3">
                                        <img src="<?php bloginfo('template_directory'); ?>/assets/img/common/nav-img6.png"
                                            alt="健康診断・在宅医療" />
                                    </div>
                            ...
                            <li>
                                <a href="<?php echo home_url() . '/about'; ?>">
                                    <div class="nav-img4">
                                        <img src="<?php bloginfo('template_directory'); ?>/assets/img/common/nav-img4.png"
                                            alt="病院紹" />
                                    </div>
                            ...
                            <li>
                                <a href="<?php echo home_url() . '/recruit'; ?>">
                                    <div class="nav-img5">
                                        <img src="<?php bloginfo('template_directory'); ?>/assets/img/common/nav-img5.png"
                                            alt="採用情報" />
                                    </div>
                            ...
                            <li class="sp-menu-toggle menu-on">
                                ...
                                <div class="menu-sub-list">
                                    <ul class="subnav-box">
                                        ...
                                        <li><a href="<?php echo home_url() . '/gairai#gairai-sec04'; ?>">外来担当医のご紹介</a>
                                        </li>
                            ...
                            <li class="sp-menu-toggle menu-on">
                                ...
                                <div class="menu-sub-list">
                                    <ul class="subnav-box">
                                        ...
                                        <li><a href="<?php echo home_url() . '/nyuuin#item04-sec'; ?>">面談・面会について</a>
                                        </li>
                            ...
                            <li class="sp-menu-toggle menu-on">
                                ...
                                <div class="menu-sub-list">
                                    <ul class="subnav-box">
                                        ...
                                        <li><a href="<?php echo home_url() . '/about#greeting-section'; ?>">院長挨拶</a>
                                        </li>
                                        <li><a href="<?php echo home_url() . '/about#overview-section'; ?>">病院概要・沿革</a>
                                        </li>
                                        <li><a href="<?php echo home_url() . '/about#traffic-section'; ?>">交通アクセス</a>
                                        </li>
                            ...
                            <li class="sp-menu-toggle menu-on">
                                ...
                                <div class="menu-sub-list">
                                    <ul class="subnav-box">
                                        ...
                                        <li><a
                                                href="<?php echo home_url() . '/recruit#recruitment-information-list'; ?>">採用情報一覧</a>
                                        </li>
                                        <li><a
                                                href="<?php echo home_url() . '/recruit#about-recruitment'; ?>">職員募集について</a>
                                        </li>
                                        <li><a
                                                href="<?php echo home_url() . '/recruit#employment-information-list'; ?>">採用情報詳細</a>
                                        </li>
                                        <li><a href="<?php echo home_url() . '/recruit#nursing-scholarship'; ?>">看護学生
                                                奨学金制度</a></li>
                                        <li><a
                                                href="<?php echo home_url() . '/recruit#certified-worker-scholarship'; ?>">介護福祉士
                                                奨学金制度</a></li>
                                    </ul>
                                </div>
                            </li>
                                ...
                                <div class="menu-list search-sp">
                                    <form method="get" id="searchform" class="searchform"
                                        ...
                                        <button type="submit" id="searchsubmit" value="検索" class="ser-btn sp">
                                            <svg class="gUZ B9u U9O kVc mr13" height="18" width="18" viewBox="0 0 24 24"
                                        ...
                                        <input type="text" value="<?php echo get_search_query() ?>" name="s"
                                            title="Search" placeholder="サイト内検索" class="menu-list-search" />
                                    </form>
            ...
            <div class="mv-block anime">
                ...
                <div class="timeTable">
                    <table class="table-pc">
                        ...
                        <tbody>
                            <tr>
                                <td class="text-left pl0 pr0">9:00-11:45</td>
                            ...
                            <tr>
                                <td class="text-left pl0 pr0">13:15-16:30</td>
                                <td><i class="circle m-auto"></i></td>
                                <td><i class="circle m-auto"></i></td>
                                <td><i class="circle m-auto"></i></td>
                                <td><i class="circle m-auto"></i></td>
                            ...
                            <tr>
                                ...
                                <td colspan="10" class="text-left pl0 pr0">
                                    <p class="addr mb10">臨時休診あり</p>
                                    <p class="addr">
                                        <i class="location"></i>
                                        <span class="addr-text">〒078-4106 北海道苫前郡羽幌町南6条5丁目13</span>
                                    </p>
                                    <div class="mv-service-btn">
                                        <a class="pc open-map-btn" target="_blank"
                                            href="https://www.google.com/maps/dir/?api=1&destination=加藤病院"><span>マップを開く</span></a>
                                    </div>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                    <p class="phone-number">お電話でのお問い合わせ<span class="ph-no font-blue">0164-62-1005</span></p>
                </div>
            </div>
        </div>